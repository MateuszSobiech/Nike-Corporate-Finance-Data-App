          ...
          <div className="flex-1 pr-7">
            ...
            <TableRoot>
              <Table className="w-full">
                <TableHead>
                  <TableRow>
                    <TableHeaderCell className="text-xs">{""}</TableHeaderCell>
                  ...
                  {dataCurrentKeys.map(({ key, label, type }) => {
                    ...
                    if (key === "current_ratio" || key === "quick_ratio") {
                      ...
                      const currentLiabilities =
                        Math.abs(filteredData[0]?.total_current_liabilities) ||
                        null
                      ...
                      const previousLiabilities =
                        Math.abs(previousData[0]?.total_current_liabilities) ||
                        null
              ...
              <Table className="w-full">
                ...
                <TableBody className="text-xs">
                  {dataTotalKeys.map(({ key, label, type }) => {
                    ...
                    if (key === "debt_ratio") {
                      const totalAssets = filteredData[0]?.total_assets || null
