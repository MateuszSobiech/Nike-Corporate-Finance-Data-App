  ...
  return (
    <div className="pt-6">
      <div className="space-y-10">
        ...
        <section>
          <h2 className="mt-20 scroll-mt-8 text-lg font-semibold text-gray-900 sm:text-xl dark:text-gray-50">
            Key Financial Measures
          </h2>
          <div className="sticky top-16 z-20 flex items-center justify-between border-b border-gray-200 bg-white pb-4 pt-4 sm:pt-4 lg:top-0 lg:mx-0 lg:px-0 lg:pt-10 dark:border-gray-800 dark:bg-gray-950">
            ...
            <div>
              <button
                className="relative hidden items-center justify-center gap-2 whitespace-nowrap rounded-md border border-gray-300 bg-white px-2 py-1 text-center text-sm font-medium text-gray-900 shadow-sm outline outline-0 outline-offset-2 outline-orange-500 transition-all duration-100 ease-in-out hover:bg-gray-50 focus-visible:outline-2 disabled:pointer-events-none disabled:text-gray-400 disabled:shadow-none sm:flex dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50 dark:outline-orange-500 dark:hover:bg-gray-900/60 disabled:dark:text-gray-600"
                type="button"
                aria-haspopup="dialog"
                aria-expanded="false"
                aria-controls="radix-:Rakvf7qja:"
                data-state="closed"
              >
                <svg
                  viewBox="0 0 24 24"
                  ...
                  fill="currentColor"
                  aria-hidden="true"
                  className="remixicon -ml-0.5 size-4 shrink-0"
                >
